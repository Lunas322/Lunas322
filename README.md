...
### 🇰🇷🇯🇵 [HanQ (한큐)](https://github.com/Lunas322/HanQ) · [Live](https://han-q.vercel.app)
한국과 일본을 잇는 **실시간 번역 Q&A 서비스**. 한국어로 질문하면 일본 사용자에겐 일본어로 보이고, 그 반대도 마찬가지. DeepL API로 작성 즉시 백그라운드 번역해 언어별로 저장하므로 조회 속도에 영향이 없습니다.
...
### 💧 [Gulpy](https://github.com/Lunas322/Gulpy) · [Live](https://gulpy-mauve.vercel.app)
물 마시는 습관을 만들어주는 **모바일 전용 PWA**. 목표 수분 섭취량을 설정하고 원하는 주기로 푸시 알림을 받아 섭취량을 기록합니다.
...
### 📝 [QuizNote](https://github.com/Lunas322/QuizNote) · [Live](http://quiznoteheo.s3-website.ap-northeast-2.amazonaws.com/)
주제를 입력하면 **Gemini AI가 문제를 생성**하고, 시험 형식으로 풀어 결과를 저장·분석하는 퀴즈 학습 서비스. 마이페이지에서 시험 통계를 조회할 수 있습니다.
